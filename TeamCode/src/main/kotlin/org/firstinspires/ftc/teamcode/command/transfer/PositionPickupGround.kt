...
class PositionPickupGround(armRotationSubsystem: ArmRotationSubsystem, activeIntakeSubsystem: ActiveIntakeSubsystem) : SequentialCommandGroup() {
    init {
        addCommands(
            ...
            RotateTo(armRotationSubsystem, ArmRotationSubsystem.ROTATION_PICKUP_POSITION_GROUND)
        )
