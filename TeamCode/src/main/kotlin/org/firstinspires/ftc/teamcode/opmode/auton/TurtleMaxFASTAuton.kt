...
//@Disabled
@Suppress("Unused")
@Autonomous(name = "Turtle Max FAST", group = "Turtle")
class TurtleMaxFASTAuton : AutonBase() {
    ...
    override fun runOpMode() {
        ...
        val trajectory = drive.actionBuilder(
            ...
            .splineToConstantHeading(Vector2d(-47.0, 14.0), Math.toRadians(100.0))
            ...
            .splineToConstantHeading(Vector2d(-52.0, 59.0), Math.toRadians(90.0), null, slowSegmentAccelerationConstraint) // Push first sample to observation zone
            ...
            .splineToConstantHeading(Vector2d(-47.5, 12.0), Math.toRadians(270.0), null, slowSegmentAccelerationConstraint) // Drive back to next pickup
