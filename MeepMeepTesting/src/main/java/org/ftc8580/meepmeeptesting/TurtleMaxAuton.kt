...
fun main(args: Array<String>) {
    ...
    val slowSegmentVelocityConstraint = TranslationalVelConstraint(50.0)
    val slowSegmentAccelerationConstraint = ProfileAccelConstraint(-30.0, 45.0)
    ...
    val bot = DefaultBotBuilder(meepMeep) // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
        ...
        .setConstraints(65.0, 58.0, Math.PI, Math.PI, 13.0)
        .build()
